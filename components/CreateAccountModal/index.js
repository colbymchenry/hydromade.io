...
export default function CreateAccountModal(props) {
    ...
    return (
        <animated.div style={close ? GoOutOfView(1400, () => props.close()) : ComeIntoView()} className={styles.container}>
            ...
            <div>
                <animated.div style={close ? FadeOutDown(1100) : FadeInUp(500)} className={`w-100 ${styles.margin1}`}>
                    <input type="email" placeholder="me@example.com" />
                    <div className={styles.label}><small>Email</small></div>
                </animated.div>
                <animated.div style={close ? FadeOutDown(800) : FadeInUp(800)} className={`w-100 ${styles.margin2}`}>
                    <input type="password" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" />
                    <div className={styles.label}><small>Password (at least 8 characters)</small></div>
                </animated.div>
                <animated.div style={close ? FadeOutDown(500) : FadeInUp(1100)} className={`w-100 ${styles.margin3}`}>
                    <input type="password" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" />
                    <div className={styles.label}><small>Password Confirmation</small></div>
                </animated.div>

                <animated.div style={close ? FadeOutDown(200) : FadeInUp(1400)} className={`w-100 d-flex justify-content-center ${styles.margin4}`}>
